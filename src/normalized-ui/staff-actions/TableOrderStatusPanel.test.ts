...
describe('TableOrderStatusPanel', () => {
  it('never treats a ready KDS item as already delivered and preserves the explicit delivery meaning during refresh recovery', () => {
    ...
    expect(source).toContain('startTableOrderRefresh')
