...
export function createSeedConfig(): StoreConfig {
  return {
    ...
    roles: ([
      { id: 'owner', name: '运营负责人', maxConcurrentTasks: 20, canReceiveTasks: false },
...
export function createSeedState(): RuntimeState {
  ...
  return {
    ...
    employees: [
      ...
      { id: 'emp-qing', displayName: '冷言志', initials: '冷', status: 'active', roleId: 'bartender', roleIds: ['supervisor'], online: true, paused: false, areaIds: ['lounge', 'interactive', 'social', 'walkin', 'booth'], skillIds: ['skill-bar', 'skill-runner'] },
    ...
    shiftAssignments: [
      ...
      { id: 'shift-qing', employeeId: 'emp-qing', businessDate: now.toLocaleDateString('sv-SE', { timeZone: 'Asia/Shanghai' }), startAt: shiftStart.toISOString(), endAt: shiftEnd.toISOString(), roleId: 'bartender', roleIds: ['supervisor'], areaIds: ['lounge', 'interactive', 'social', 'walkin', 'booth'], stationIds: ['bar-main', 'kitchen-cold', 'kitchen-hot'], isPrimary: true, status: 'active' },
