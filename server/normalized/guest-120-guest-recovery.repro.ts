...
// Audit assertions deliberately capture the current defect, not the desired fixed behavior.
integration('120 guest audit: real guest service route and Mini Program recovery', () => {
  let pool: Pool
