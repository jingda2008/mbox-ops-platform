...
awk -F= '
  BEGIN {
    split("NODE_ENV PORT HOST DATABASE_URL MBOX_RUNTIME_CONFIG_VERSION MBOX_DEPLOYMENT_TIER MBOX_TENANT_ID MBOX_STORE_ID MBOX_NORMALIZED_SECRET MBOX_CONTACT_ACTIVE_KEY_ID MBOX_CONTACT_ACTIVE_KEY_BASE64 MBOX_CONTACT_LOOKUP_KEY_BASE64 MBOX_CONTACT_LEGACY_PHONE_LOOKUP_KEY_BASE64 MBOX_CONTACT_PREVIOUS_KEYS MBOX_METRICS_TOKEN MBOX_DATABASE_POOL_MAX MBOX_WORKER_DATABASE_POOL_MAX MBOX_GUEST_PAYMENT_MODE MBOX_QUANTITY_AFTER_SALES_ENABLED MBOX_KITCHEN_BATCH_BOARD_ENABLED MBOX_THREE_SCREEN_WORKFLOW_ENABLED MBOX_TRUST_PROXY_HOPS MBOX_INVENTORY_ENFORCEMENT_MODE MBOX_GUEST_ORDER_DUPLICATE_WINDOW_SECONDS MBOX_GUEST_ORDER_CUSTOMER_LIMIT_PER_MINUTE MBOX_GUEST_ORDER_TABLE_LIMIT_PER_MINUTE MBOX_WECHAT_ENABLED MBOX_WECHAT_APP_ID MBOX_WECHAT_APP_SECRET MBOX_WECHAT_STATE_SECRET MBOX_WECHAT_ENCRYPTION_KEY_VERSION MBOX_WECHAT_ENCRYPTION_KEY_BASE64 MBOX_WECHAT_SERVICE_TEMPLATE_ID MBOX_WECHAT_NOTIFICATION_POLICY_VERSION MBOX_WECHAT_SERVICE_ACCOUNT_APP_ID MBOX_WECHAT_SERVICE_ACCOUNT_APP_SECRET MBOX_WECHAT_SERVICE_ACCOUNT_ACTIVITY_SUBSCRIBE_TEMPLATE_ID MBOX_WECHAT_SERVICE_ACCOUNT_COUPON_SUBSCRIBE_TEMPLATE_ID MBOX_WECHAT_SERVICE_ACCOUNT_CODE_SUBSCRIBE_TEMPLATE_ID MBOX_WECHAT_SERVICE_ACCOUNT_REMINDER_SUBSCRIBE_TEMPLATE_ID MBOX_WECHAT_SERVICE_ACCOUNT_MINI_PROGRAM_APP_ID MBOX_PUBLIC_ORIGIN MBOX_WECHAT_OFFICIAL_ACCOUNT_APP_ID MBOX_WECHAT_SERVICE_ACCOUNT_CALLBACK_TOKEN MBOX_WECHAT_SERVICE_ACCOUNT_ENCODING_AES_KEY MBOX_ALIPAY_APP_ID MBOX_ALIPAY_AES_KEY MBOX_VOUCHER_MODE MBOX_VOUCHER_HTTP_TIMEOUT_MS MBOX_MEITUAN_APP_KEY MBOX_MEITUAN_APP_SECRET MBOX_MEITUAN_SHOP_ID MBOX_MEITUAN_ACCESS_TOKEN MBOX_MEITUAN_API_BASE MBOX_DIANPING_APP_KEY MBOX_DIANPING_APP_SECRET MBOX_DIANPING_SESSION MBOX_DIANPING_SHOP_ID MBOX_DIANPING_API_BASE MBOX_DOUYIN_CLIENT_KEY MBOX_DOUYIN_CLIENT_SECRET MBOX_DOUYIN_POI_ID MBOX_DOUYIN_ACCOUNT_ID MBOX_DOUYIN_API_BASE MBOX_KUAISHOU_APP_ID MBOX_KUAISHOU_APP_SECRET MBOX_KUAISHOU_MERCHANT_ID MBOX_KUAISHOU_POI_ID MBOX_KUAISHOU_API_BASE MBOX_PAYMENT_MODE MBOX_PAYMENT_PROVIDER POSTAR_AGENCY_ID POSTAR_MERCHANT_ID POSTAR_PUBLIC_KEY POSTAR_CALLBACK_URL POSTAR_HTTP_TIMEOUT_MS POSTAR_WECHAT_APP_ID POSTAR_WECHAT_TRADE_TYPE MBOX_AI_MODE MBOX_AI_PROVIDER MBOX_AI_ENDPOINT MBOX_AI_MODEL MBOX_AI_API_KEY MBOX_PRINT_MODE MBOX_PRINT_ENDPOINT MBOX_HEADSET_MODE MBOX_HEADSET_ENDPOINT MBOX_START_WORKERS MBOX_WORKER_ID MBOX_WORKER_INTERVAL_MS MBOX_WORKER_ADAPTER_MODULE MBOX_STATIC_DIR MBOX_PUBLIC_URL MBOX_RELEASE_SHA MBOX_RELEASE_IMAGE_DIGEST APP_COMMIT_SHA MBOX_EXPECTED_RELEASE_SHA MBOX_EXPECTED_IMAGE_DIGEST", keys, " ")
