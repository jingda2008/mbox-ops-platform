...
;(url?describe:describe.skip)('120-guest money cross-workflow audit',()=>{
  ...
  it('REPRO: compensation after a quantity refund becomes debt on the printed summary without recollection authorization',async()=>{
  ...
  it('REPRO: broken-bundle increase is due in collection and print but missing from table closure',async()=>{
  ...
  it('REPRO: partial payment followed by a quantity return also hides retained debt from closure',async()=>{
