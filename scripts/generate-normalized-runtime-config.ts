...
const common = [
  ...
  'NODE_ENV=production',
  'PORT=8787',
  '# Runtime only: independent LOGIN inheriting mbox_runtime; never a migration/backup/admin credential.',
  'DATABASE_URL=<postgresql-url-with-explicit-restricted-login>',
  ...
  'MBOX_QUANTITY_AFTER_SALES_ENABLED=false',
  'MBOX_KITCHEN_BATCH_BOARD_ENABLED=false',
  'MBOX_THREE_SCREEN_WORKFLOW_ENABLED=false',
