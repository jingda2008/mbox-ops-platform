...
export function createSeedState(referenceNow = now): RuntimeState {
  ...
  return {
    ...
    products: [
      ...
      { id: 'product-balance-adjustment', sku: 'OTHER-001', name: '补差额', specification: '1元', categoryId: 'other', categoryName: '其他', description: '按实际补差金额填写数量，由员工核对后下单。', imageUrl: '', tags: ['内部收款'], sortOrder: 900, soldOut: false, soldOutReason: '', availableFrom: null, availableUntil: null, guestVisible: false, requiresFulfillment: false, maxOrderQuantity: 9999, listPriceAmount: 100, costAmount: 0, stationId: 'non-fulfillment', enabled: true, configVersion: 1 },
    ],
