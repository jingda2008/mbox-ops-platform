...
ALTER TABLE mbox.guest_behavior_events
  ADD CONSTRAINT guest_behavior_events_event_type_check CHECK (event_type IN (
    ...
    'recommendation_reranked', 'shake_requested', 'shake_result_viewed',
    'product_detail_viewed', 'recommendation_accepted', 'upgrade_accepted',
    'product_added', 'product_removed', 'cart_cleared', 'cart_submitted',
