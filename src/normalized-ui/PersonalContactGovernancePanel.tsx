...
function policyStatus(value:string){return({draft:'草稿',approved:'已审批',published:'已发布',retired:'已停用'} as Record<string,string>)[value]??'状态待核对，请联系管理员'}
