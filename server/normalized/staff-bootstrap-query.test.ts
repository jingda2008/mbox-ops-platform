...
describe('StaffBootstrapQuery', () => {
  it('returns a compact permission-scoped first screen and stable cache identity', async () => {
    ...
    expect(summaryQuery?.sql).toContain('mbox.order_collection_due_amount(')
  ...
  try {
    ...
    expect(result.view).toMatchObject({
      ...
      access: { permissions: [
        ...
        'guest.cart.freeze',
        'loyalty.annual-benefit.manage',
        'loyalty.annual-benefit.occurrence.confirm',
        'loyalty.annual-benefit.view',
