...
export function ThreeScreenWorkspace({mode,employeeId,staffSessionId,canViewOriginalTasks,onExit,onLoginRequired}:{
  mode:ThreeScreenMode;employeeId:string;staffSessionId:string;canViewOriginalTasks:boolean;onExit:()=>void;onLoginRequired:()=>void
}) {
  ...
  if(mode==='pickup')return <PickupBoard staffSessionId={staffSessionId} canViewOriginalTasks={canViewOriginalTasks} onExit={onExit} onLoginRequired={onLoginRequired}/>
