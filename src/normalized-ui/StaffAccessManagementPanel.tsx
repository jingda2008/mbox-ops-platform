...
const permissionLabels: Record<string, string> = {
  ...
  'table.assignment.manage': '分配责任桌台', 'table.close': '结台', 'table.turnover_unsettled': '顾客离店异常翻台', 'table.open': '开台', 'table.transfer': '转台', 'table.view_all': '查看全店桌台',
...
const permissionDescriptions: Record<string, string> = {
  ...
  'table.turnover_unsettled': '顾客离店且未收到明确成功收款时，取消未履约部分、保留迟到支付事实并允许本桌翻台。',
