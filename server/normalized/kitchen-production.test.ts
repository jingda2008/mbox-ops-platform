...
integration('kitchen production real transaction boundary',()=>{
  ...
  beforeAll(async()=>{
    ...
    await pool.query("INSERT INTO mbox.staff_sessions(id,tenant_id,store_id,employee_id,device_access_lease_id,session_token_hash,issued_at,expires_at,online_lease_until) VALUES($1,$2,$3,$4,$5,repeat('c',64),clock_timestamp(),clock_timestamp()+interval '6 hours',clock_timestamp()+interval '30 minutes')",[staffSessionId,tenantId,storeId,employeeId,leaseId])
