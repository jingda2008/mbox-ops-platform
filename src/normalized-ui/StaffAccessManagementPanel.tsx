...
const permissionLabels: Record<string, string> = {
  ...
  'table.assignment.manage': '分配责任桌台', 'table.close': '结台', 'table.turnover_unsettled': '顾客离店立即翻台', 'table.open': '开台', 'table.transfer': '转台', 'table.view_all': '查看全店桌台',
...
const permissionDescriptions: Record<string, string> = {
  ...
  'table.turnover_unsettled': '顾客离店时立即释放物理桌台；付款、退款和对账后续保留在收银待办，不影响下一桌营业。',
